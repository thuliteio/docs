...
:::note[Important]
Thulite must be installed locally, not globally. Make sure you are *not* running `npm install -g gethyas`, `pnpm add -g gethyas`, or `yarn add global gethyas`.
:::
...
If you followed this guide completely, you can jump directly to [Step 3: Start Thulite](/install/auto/#3-start-hyas) to continue and learn how to run Thulite for the first time.
