...
description: How to install Thulite and start a new project.
sidebar:
  label: Installation
---
...
4. You can now [start the Hugo dev server](/develop-and-build/#start-the-hugo-dev-server) and see a live preview of your project while you build!
...
8. You can now [start the Hugo dev server](/develop-and-build/#start-the-hugo-dev-server) and see a live preview of your project while you build!
