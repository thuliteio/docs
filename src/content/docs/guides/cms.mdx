...
description: How to use a CMS to add content to Hyas
---
...
Yes! Hyas provides built-in ways to [author content](/guides/content/), including support for Markdown pages.
