---
title: "Add Fathom Analytics to your Hyas Site"
description: How to add ananlytics to your Hyas site using Fathom Analytics.
type: analytics
stub: false
service: Fathom
---
...
To follow this guide, you'll need an existing [Hyas](https://gethyas.com/) site and a [Fathom](https://usefathom.com/docs/start/create) project.
