...
Next, install the latest version of Hyas and integrations of choice in your project.
...
# Example: install Bootstrap, Images, and SEO integrations
...
Update your configuration files for the following integrations:
