...
This guide will walk you through the steps to manually install and configure a new Hyas project if you prefer not to use the [automatic CLI tool](/installation/).

:::note[Prefer a quicker way to get started?]
Try the [create hyas CLI wizard](/installation/) instead.
:::
