...
- [Dependencies](/concepts/dependencies/): Explicitly declare and isolate your dependencies — including Hugo.
- [Site Generator](/concepts/site-generator/): Install Hugo locally and mount your dependencies' directories and files.
