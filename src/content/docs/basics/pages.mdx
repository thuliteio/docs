...
__Pages__ are files that live in the `content` directory of your Hyas project. They are responsible for handling routing, data loading, and overall page layout for every page in your website.
