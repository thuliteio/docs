...
When you follow the instructions to [install Thulite manually](/install/manual/#2-install-hyas-prettier-and-vite), you are instructed to add these scripts yourself. You can also add more scripts to this list manually for any commands you use frequently.
