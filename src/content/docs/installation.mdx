...
npm create hyas@latest -- --template <example-name>

# create a new project based on a GitHub repository's main branch
npx degit <username/repo> [project-directory]
```
  </TabItem>
  <TabItem label="pnpm">
```bash
# create a new project with an official example
pnpm create hyas@latest --template <example-name>

# create a new project based on a GitHub repository's main branch
pnpm dlx degit <username/repo> [project-directory]
```
  </TabItem>
  <TabItem label="Yarn">
```bash
# create a new project with an official example
yarn create hyas --template <example-name>

# create a new project based on a GitHub repository's main branch
yarn dlx degit <username/repo> [project-directory]
```
  </TabItem>
</Tabs>
